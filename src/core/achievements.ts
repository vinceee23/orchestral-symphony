...
export const ACHIEVEMENTS: AchievementConfig[] = [
  ...
  },
  {
    ...
    icon: '\u{1F405}',
    check: (s) => s.opusCount >= 1 && s.tiers.some((t) => t.purchased >= 500),
    reward: { none: true },
    rewardDescription: 'Collectible — no bonus',
  },
  {
  ...
  },
  {
    ...
    icon: '\u{1F680}',
    check: (s) => s.opusCount >= 1 && s.soundwaves.gte('1e125'),
    reward: { globalPercent: 0.10 },
    rewardDescription: '+10% all production',
  },
  {
  ...
  },
  {
    ...
    icon: '\u{1F31C}',
    check: (s) => s.opusCount >= 1 && s.tempo.baseBPM >= 2500,
  ...
  },
  {
    ...
    icon: '\u{1F985}',
    check: (s) => s.opusCount >= 3 && s.soundwaves.gte('1e220'),
  ...
  },
  {
    ...
    description: 'Own 250 of every tier (post-Magnum Opus)',
    icon: '\u{1F574}',
    check: (s) => s.opusCount >= 1 && s.tiers.every((t) => t.purchased >= 250),
    reward: { costReduction: 0.10 },
    rewardDescription: '-10% all costs',
  },
  {
